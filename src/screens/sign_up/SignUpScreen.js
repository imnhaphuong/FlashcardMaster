    ...
    <SafeAreaView style={{ flex: 1 }}>
          ...
          <View style={{ maxWidth:'100%',maxHeight: "100%"}}>
            ...
            <View style={{ marginHorizontal: 20,maxWidth:'100%' ,maxHeight: "100%", marginTop: 200 }} >
              ...
              <CustomButton text="Đăng ký" onPress={onSignIn} hide="hide" />
              ...
              <CustomButton text="Đăng ký bằng Google" onPress={onSignInGoogle} type="GG" />
            </View>
          </View>
          {/* bottom */}
          <View style={{width: 418, height:'100%'}}>
            <VectorBot />
          </View>
